...
public class LauncherController {
	...
	public void rbOnActionPlayer2(ActionEvent event) {
		...
		/*
		 * Die Textfelder und ComboBoxen fuer den Spieler 1 und Spieler 2 werden aktiviert, außer die Farbauswahl für Spieler 2.+
	 ...
	 * @param event Parameter für jeweiliges Event
	 */
	 ...
	 * @return Es wird false zurueckgegeben, wenn nicht alles richtig und vollstaendig ist, also die TextFelder nicht oder falsch ausgefuellt wurden, hierzu zaehlt auch die Eingabe von Sonderzeichen oder eine zu GroÃƒÅ¸e oder zu Kleine Eingabe erfolgt ist oder mehrere Spieler die gleiche Farbe gewaehlt haben
